...
sɪɢᴍᴀ_ᴍᴅ.Module_Exports({
 ...
 async(bot, person, text ,{isCreator }) => {
   ...
   let Maher = [];
          ...
          else Maher.push(`┏━━↱↱ ${mztit} ↲━❐\n➫〥 ᴄᴏᴍᴍᴀɴᴅ ${cmd.kingcmd}`);
          if (cmd.kingclass) Maher.push(`➫〥 ᴄʟᴀss ${cmd.kingclass}`);
          if(cmd.kingpath) Maher.push(`➫〥 ꜰɪʟᴇ-ᴘᴀᴛʜ ${cmd.kingpath}\n┗━━━━━━━━━━❐\n${name.caption}`)
